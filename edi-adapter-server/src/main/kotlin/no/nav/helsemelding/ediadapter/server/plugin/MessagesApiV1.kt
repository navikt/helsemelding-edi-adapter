...
import no.nav.helsemelding.ediadapter.model.v1.AppRecError
import no.nav.helsemelding.ediadapter.model.v1.AppRecStatus
import no.nav.helsemelding.ediadapter.model.v1.AppRecStatus.OK_ERROR_IN_MESSAGE_PART
import no.nav.helsemelding.ediadapter.model.v1.ApprecInfo
import no.nav.helsemelding.ediadapter.model.v1.DeliveryState.ACKNOWLEDGED
import no.nav.helsemelding.ediadapter.model.v1.EbXmlInfo
import no.nav.helsemelding.ediadapter.model.v1.Message
import no.nav.helsemelding.ediadapter.model.v1.Metadata
import no.nav.helsemelding.ediadapter.model.v1.OrderBy
