...
internal fun Raise<ValidationError>.messageQueryParams(
    ...
    return Parameters.build {
        ...
        appendIfPresent("BusinessDocumentId", businessDocumentId)
        appendIfPresent("IncludeMetadata", includeMetadata)
        appendIfPresent("MessagesToFetch", messagesToFetch)
        appendIfPresent("OrderBy", orderBy)
    }
}
